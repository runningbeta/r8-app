...
const PausableUpgradeableProxy = artifacts.require('lifecycle/PausableUpgradeableProxy');
...
contract('PausableUpgradeableProxy', function (accounts) {
  ...
  describe('pauseProxy', function () {
    beforeEach(async function () {
      const {logs} = await this.factory.newPausableUgradeableProxy(web3Utils.utf8ToHex('1.0'), this.impl_v1_0.address, contentURI);
